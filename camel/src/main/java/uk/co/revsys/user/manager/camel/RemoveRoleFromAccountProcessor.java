...
public class RemoveRoleFromAccountProcessor extends HttpProxyProcessor {

    private String account;
    private String role;

    public RemoveRoleFromAccountProcessor(String baseUrl) {
        super(baseUrl);
    }
    ...
    public String getUrlPath(Exchange exchange) {
        return "/accounts/" + getAccount()+ "/removeRole";
    }
